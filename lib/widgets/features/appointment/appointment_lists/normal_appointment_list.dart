...
import 'package:clinic_khojo/widgets/features/appointment/appointment_tiles/normal_tiles.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
class NormalAppointmentList extends StatefulWidget {
  const NormalAppointmentList({super.key});

  @override
  State<NormalAppointmentList> createState() => _NormalAppointmentListState();
}

class _NormalAppointmentListState extends State<NormalAppointmentList> {
  Map<int,bool>myMap={};
    @override
    void initState() {
      super.initState();
