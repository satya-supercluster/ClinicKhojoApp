...
class NormalAppointmentTile extends StatefulWidget {
  final String name;
  final String age;
  final String place;
  final String gender;
  ...
  @override
  State<NormalAppointmentTile> createState() => _NormalAppointmentTileState();
}

class _NormalAppointmentTileState extends State<NormalAppointmentTile> {
  @override
